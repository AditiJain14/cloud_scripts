...
generate_single_path(){
    ...
    name="lmlossApril14_0.1_0.1_0.3" #"latency_${lambda}"
    ...
    python "${FAIRSEQ}/scripts/average_checkpoints.py" --inputs ${modelfile} --num-epoch-checkpoints 3 --checkpoint-upper-bound 26 --output ${modelfile}/average-model.pt 
