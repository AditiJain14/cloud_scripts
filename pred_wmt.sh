...
generate_single_path(){
    ...
    name="lmlossApril11_0.1_0.30.3" #"latency_${lambda}"
...
#     python "${FAIRSEQ}/scripts/average_checkpoints.py" --inputs ${modelfile} --num-epoch-checkpoints 6 --checkpoint-upper-bound 31 --output ${modelfile}/average-model.pt 
